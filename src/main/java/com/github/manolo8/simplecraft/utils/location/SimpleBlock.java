...
//    public Block getByMachine(Machine machine) {
//        return this.clone().rotate(machine.getFace()).add(machine.base()).getBlock(machine.worldInfo().getWorld());
//    }

//    public void updateByMachine(Machine machine) {
//        getByMachine(machine).setType(material);
//    }
